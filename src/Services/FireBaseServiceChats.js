 ...
 *
 * Stored under `rating` rather than the `feedbackData` field older messages
 * carry. That field held the retired quiz/flashcard popover's shape
 * ({ rating: 'good', detail }); nothing writes or reads it any more, and
 * reusing the name would make historical rows indistinguishable from current
 * ones. Existing documents keep theirs — it is simply inert.
 *
